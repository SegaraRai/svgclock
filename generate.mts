...
function calculateCountryCodeToTimezoneMap() {
  return Object.fromEntries(
    Array.from(
      new Map(getTimeZones().map((tz) => [tz.countryCode, tz.name])).entries()
...
export const PRECALCULATED_COUNTRY_TIMEZONE_MAP = ${JSON.stringify(
  calculateCountryCodeToTimezoneMap(),
  null,
  2
)} as const;
